...
const ETATS = {
  ...
  devis:         { court: 'Chiffrage',   long: 'Chiffrage en cours',    client: 'Chiffrage en cours',     rail: 'plan', pip: 'plan' },
  attente:       { court: 'Chez le client',long: 'En attente client',     client: 'À vous de répondre',     rail: 'wait', pip: 'wait' },
  production:    { court: 'En production',long: 'En production',         client: 'En production',          rail: 'work', pip: 'work' },
  relecture:     { court: 'Relecture',   long: 'Relecture interne',     client: 'Relecture Line Up',      rail: 'plan', pip: 'plan' },
  validation:    { court: 'À valider',   long: 'Validation client',     client: 'À vous de valider',      rail: 'wait', pip: 'wait' },
...
const SOUS_ETATS = {
  ...
  fait:     { court: 'Terminé',  client: 'Terminée',   rail: 'live', pip: 'live' },
};
...
const RESEAUX = {
  instagram: { label: 'Instagram', icon: 'instagram', serie: '#9e2e86' },
  facebook:  { label: 'Facebook',  icon: 'facebook',  serie: '#2fa9c9' },
  linkedin:  { label: 'LinkedIn',  icon: 'linkedin',  serie: '#5b37c0' },
  tiktok:    { label: 'TikTok',    icon: 'tiktok',    serie: '#c98a16' },
};

const SERIE = ['#2fa9c9', '#9e2e86', '#c98a16', '#5b37c0'];
...
const RAMPE = ['#c9e8f2', '#9ed7e8', '#6fc2da', '#3fabc9', '#2a8dab', '#1d6e88', '#134f64'];
...
const EQUIPE = [
  { id: 'am', prenom: 'Adrien',   nom: 'M.', initiales: 'AM', role: 'Chef de projet',              couleur: '#b03050', entree: '2020-11-16', contrat: 'CDI', tjm: 450, conges: { acquis: 25, pris: 20, solde: 5 },  rtt: 3, charge: 0.93 },
  { id: 'bb', prenom: 'Benjamin', nom: 'B.', initiales: 'BB', role: 'Direction artistique & motion', couleur: '#5b37c0', entree: '2021-03-01', contrat: 'CDI', tjm: 480, conges: { acquis: 25, pris: 11, solde: 14 }, rtt: 4, charge: 0.96 },
  { id: 'jo', prenom: 'Jocelyne', nom: '',   initiales: 'JO', role: 'Vidéo & community management', couleur: '#0d7f9e', entree: '2022-09-12', contrat: 'CDI', tjm: 430, conges: { acquis: 25, pris: 18, solde: 7 },  rtt: 2, charge: 1.04 },
];
...
const CHANTIERS = [
  {
    ...
    clientId: 'papiours', type: 'Vidéo sociale', etat: 'production', priorite: 'haute', ownerId: 'jo',
    ...
    taches: [
      { id: 't1', nature: 'tournage', label: 'Aller tourner — service du dimanche', etat: 'fait', ownerId: 'jo', duree: 4, echeance: D(-4, 12, 0) },
      { id: 't2', nature: 'derush', label: 'Dérushage 3 h de rushes', etat: 'fait', ownerId: 'jo', duree: 2, echeance: D(-2, 18, 0) },
      { id: 't3', nature: 'montage', label: 'Montage 30 s vertical', etat: 'en_cours', ownerId: 'jo', duree: 3, echeance: D(1, 12, 0) },
      { id: 't4', nature: 'da', label: 'Habillage titres & sous-titres', etat: 'a_faire', ownerId: 'bb', duree: 1.5, echeance: D(2, 12, 0) },
      { id: 't5', nature: 'program', label: 'Programmation IG + TikTok', etat: 'a_faire', ownerId: 'jo', duree: 0.5, echeance: D(3, 17, 0) },
    ],
    fichiers: [
    ...
    fil: [
      ...
      { qui: 'Jocelyne', cote: 'agence', quand: D(-2, 18, 10), texte: "Dérushage terminé, on a un très beau plan de dressage. Montage en cours." },
    ],
  },
  {
    id: 'LU-2431', slug: 'KALPY_LIVREBLANC_CARROUSEL', titre: 'Carrousel LinkedIn — livre blanc automatisation',
    clientId: 'kalpy', type: 'Carrousel', etat: 'validation', priorite: 'haute', ownerId: 'bb',
    ...
    taches: [
      { id: 't1', nature: 'redac', label: 'Écriture des 8 slides', etat: 'fait', ownerId: 'jo', duree: 2, echeance: D(-4, 17, 0) },
      { id: 't2', nature: 'da', label: 'Mise en page charte Kalpy', etat: 'fait', ownerId: 'bb', duree: 3, echeance: D(-2, 17, 0) },
      { id: 't3', nature: 'export', label: 'Export 1080×1350 ×8', etat: 'fait', ownerId: 'bb', duree: 0.5, echeance: D(-1, 12, 0) },
      { id: 't4', nature: 'program', label: 'Programmation LinkedIn', etat: 'a_faire', ownerId: 'jo', duree: 0.5, echeance: D(1, 17, 0) },
    ],
    ...
    fil: [
      ...
      { qui: 'Benjamin B.', cote: 'agence', quand: D(-1, 11, 20), texte: "V2 en ligne dans votre espace, avec le chevron en fil conducteur sur les 8 slides." },
    ],
  },
  {
    ...
    taches: [
      { id: 't1', nature: 'tournage', label: 'Aller tourner — golden hour', etat: 'a_faire', ownerId: 'jo', duree: 3, echeance: D(6, 19, 0) },
      { id: 't2', nature: 'retouche', label: 'Retouche 12 photos', etat: 'a_faire', ownerId: 'bb', duree: 4, echeance: D(8, 18, 0) },
      { id: 't3', nature: 'program', label: 'Programmation IG + FB', etat: 'a_faire', ownerId: 'jo', duree: 0.5, echeance: D(9, 17, 0) },
    ],
    fichiers: [],
    fil: [
  ...
  },
  {
    ...
    clientId: 'ocres', type: 'Série éditoriale', etat: 'relecture', priorite: 'normale', ownerId: 'jo',
    ...
    taches: [
      { id: 't1', nature: 'tournage', label: 'Aller tourner — premier jour', etat: 'fait', ownerId: 'jo', duree: 4, echeance: D(-6, 12, 0) },
      { id: 't2', nature: 'retouche', label: 'Retouche série', etat: 'fait', ownerId: 'bb', duree: 3, echeance: D(-2, 18, 0) },
      { id: 't3', nature: 'redac', label: 'Légendes des 6 posts', etat: 'en_cours', ownerId: 'jo', duree: 2, echeance: D(2, 18, 0) },
    ],
  ...
  },
  {
    ...
    clientId: 'ferrand', type: 'Identité sociale', etat: 'devis', priorite: 'normale', ownerId: 'bb',
    ...
    taches: [
      { id: 't1', nature: 'da', label: 'Planches de recherche', etat: 'en_cours', ownerId: 'bb', duree: 4, echeance: D(4, 18, 0) },
    ],
    fichiers: [],
  ...
  },
  {
    ...
    clientId: 'vaganay', type: 'Post', etat: 'pret', priorite: 'normale', ownerId: 'bb',
    ...
    taches: [
      { id: 't1', nature: 'da', label: 'Visuel feed + story', etat: 'fait', ownerId: 'bb', duree: 2, echeance: D(-1, 18, 0) },
      { id: 't2', nature: 'program', label: 'Programmation', etat: 'fait', ownerId: 'jo', duree: 0.5, echeance: D(0, 12, 0) },
    ],
    fichiers: [], fil: [],
  },
  {
  ...
  },
  {
    ...
    clientId: 'kalpy', type: 'Vidéo sociale', etat: 'en_ligne', priorite: 'normale', ownerId: 'bb',
    ...
    taches: [
      { id: 't1', nature: 'da', label: 'Story-board motion', etat: 'fait', ownerId: 'bb', duree: 2, echeance: D(-14) },
      { id: 't2', nature: 'montage', label: 'Animation After Effects', etat: 'fait', ownerId: 'bb', duree: 4, echeance: D(-8) },
      { id: 't3', nature: 'program', label: 'Programmation', etat: 'fait', ownerId: 'jo', duree: 0.5, echeance: D(-5) },
    ],
    fichiers: [], fil: [],
  },
  {
    id: 'LU-2409', slug: 'PAPIOURS_MENU_SEMAINE_S32', titre: 'Menu de la semaine — S32',
    clientId: 'papiours', type: 'Post récurrent', etat: 'echec', priorite: 'haute', ownerId: 'jo',
    ...
    taches: [
      { id: 't1', nature: 'da', label: 'Gabarit menu S32', etat: 'fait', ownerId: 'bb', duree: 0.5, echeance: D(-3) },
      { id: 't2', nature: 'program', label: 'Republication après renouvellement du jeton', etat: 'bloque', ownerId: 'jo', duree: 0.25, echeance: D(0, 12, 0) },
    ],
    fichiers: [], fil: [],
...
const CONGES = [
  { id: 'C-118', qui: 'jo', type: 'Congés payés', du: D(12), au: D(19), jours: 6, etat: 'attente', depose: D(-2) },
  { id: 'C-117', qui: 'jo', type: 'RTT', du: D(5), au: D(5), jours: 1, etat: 'attente', depose: D(-1) },
  { id: 'C-116', qui: 'bb', type: 'Congés payés', du: D(-14), au: D(-8), jours: 5, etat: 'valide', depose: D(-40) },
  { id: 'C-115', qui: 'bb', type: 'Sans solde', du: D(28), au: D(30), jours: 3, etat: 'refuse', depose: D(-6), motif: 'Chevauche le tournage Kalpy du 29.' },
  { id: 'C-114', qui: 'am', type: 'Congés payés', du: D(22), au: D(36), jours: 10, etat: 'valide', depose: D(-25) },
];

const FRAIS = [
  { id: 'F-341', qui: 'jo', objet: 'Péage + carburant — tournage Bertin', montant: 68.4, date: D(-5), categorie: 'Déplacement', etat: 'attente', justificatif: true },
  { id: 'F-340', qui: 'bb', objet: 'Licence police de caractères Anton Pro', montant: 129, date: D(-6), categorie: 'Logiciel', etat: 'attente', justificatif: true },
  ...
  { id: 'F-338', qui: 'jo', objet: 'Cartes SD 128 Go ×2', montant: 79.9, date: D(-12), categorie: 'Matériel', etat: 'valide', justificatif: true, rembourse: D(-1) },
  { id: 'F-337', qui: 'jo', objet: 'Abonnement outil de veille', montant: 24, date: D(-14), categorie: 'Logiciel', etat: 'refuse', justificatif: false, motif: 'Justificatif manquant' },
];

const RENDEZVOUS = [
  { id: 'R-77', quand: D(0, 14, 0), duree: 60, clientId: 'papiours', objet: 'Point mensuel + brief soirée concert', qui: ['am', 'jo'], lieu: 'Sur place' },
  { id: 'R-78', quand: D(1, 10, 30), duree: 45, clientId: 'kalpy', objet: 'Validation carrousel livre blanc', qui: ['bb'], lieu: 'Visio' },
  { id: 'R-79', quand: D(2, 9, 0), duree: 90, clientId: 'ferrand', objet: 'Présentation des pistes graphiques', qui: ['bb', 'am'], lieu: 'Marseille' },
  { id: 'R-80', quand: D(4, 16, 0), duree: 30, clientId: 'sudtoit', objet: 'Cadrage format avant/après', qui: ['am'], lieu: 'Téléphone' },
  { id: 'R-81', quand: D(7, 11, 0), duree: 120, clientId: 'ocres', objet: 'Repérage tournage caveau', qui: ['jo', 'bb'], lieu: 'Roussillon' },
];
...
const ACTIVITE = [
  { quand: D(0, 8, 42), qui: 'jo', texte: 'a programmé 3 publications pour Domaine des Ocres' },
  { quand: D(0, 8, 12), qui: null, texte: 'Publication Facebook « Menu de la semaine — S32 » en échec : jeton expiré', alerte: true },
  { quand: D(0, 7, 55), qui: 'jo', texte: 'a passé « Montage 30 s vertical » en cours sur LU-2418' },
  { quand: D(-1, 18, 4), qui: 'bb', texte: 'a déposé la V2 du carrousel Kalpy pour validation client' },
  ...
  { quand: D(-2, 17, 40), qui: 'bb', texte: 'a terminé le dérushage de l’interview Bertin' },
];
